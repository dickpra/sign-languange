...
def start_camera_loop(model):
    ...
    def camera_loop():
        ...
        try:
            ...
            # Gunakan font TrueType yang mendukung karakter non-Latin
            font_path = get_resource_path('assets/font/arial.ttf')
            font2 = ImageFont.truetype(font_path, 15)  # Path ke file font yang mendukung karakter non-Latin
            ...
            # Menambahkan teks instruksi di frame kamera (kiri bawah)
